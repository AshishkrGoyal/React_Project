...
Add_Player = React.createClass(
    {
        ...
        onNameChange: function (e) {
            console.log('Onchange Has Been Triggered',e.target.value);
            this.setState(
                {
                    name: e.target.value,
                }
...
Application = React.createClass(
    {
        ...
        onPlayerAdd: function (name) {
            ...
            this.setState(this.state); //Important Statement For Update State
        },

        onRemove: function (index) {
            /*console.log('Ashish Kritika');*/
        ...
        render: function () {
            return(
                <div className="application">
                    ...
                    <Add_Player onAdd={this.onPlayerAdd}/>
